...
THETA_VEL_WINDOW = 2
ENCODER_VEL_WINDOW = 60
# ENCODER_VEL_WINDOW = 30

# Open Loop Intersection Distances
# DIST_FROM_STOP_LINE = 32
DIST_FROM_STOP_LINE = 29#32
STRAIGHT_DIST = DIST_FROM_STOP_LINE + 20#30
LEFT_TURN_DIST = DIST_FROM_STOP_LINE + 20#15
LEFT_SECOND_STRAIGHT_DIST = 5#10
...
STRAIGHT_SPEED_LIMIT = STRAIGHT_SPEED_LIMIT_FAST

# TURN_SPEED_LIMIT = 10.0 # cm/s
TURN_SPEED_LIMIT = 15.0 # cm/s
...
LEFT_TURN = (WHEEL_BASE * np.pi / 4) * 1.5
# RIGHT_TURN = (WHEEL_BASE * np.pi / 4) * 2.2 * 8/9 + 2
RIGHT_TURN = (WHEEL_BASE * np.pi / 4) * 2.2 * 8/9 + 2 - 3
# BAUDRATE = 9600
BAUDRATE = 115200
...
PING_MIN_STRAIGHT = 20
PING_WINDOW_STRAIGHT = 25
PING_MIN_INTERSECTION = 5
